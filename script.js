...
function runBootSequence() {
  ...
  const terminal = document.getElementById('boot-lines');
...
function showAuthScreen() {
  ...
  document.querySelectorAll('.auth-tab').forEach(tab=>{
    tab.onclick=()=>{document.querySelectorAll('.auth-tab').forEach(t=>t.classList.remove('active'));tab.classList.add('active');
      ...
      document.getElementById('signup-form').style.display=isLogin?'none':'block';hideAuthError();};
  });
...
function logout(){currentUser=null;document.getElementById('main-app').style.display='none';document.getElementById('login-user').value='';document.getElementById('login-pass').value='';showAuthScreen();}
